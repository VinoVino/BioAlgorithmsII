...
def define_EmissionMatrix(EmissionMatrix,StatesChar,States,EmissionsChar,Emissions):
    ...
    for i in range (len(StatesChar)):
        for j in range (len(EmissionsChar)):
...
def main(argv):
    ...
    EmissionMatrix = [[0 for j in range(len(EmissionChar))] for i in range(len(StatesChar))]  # 2D list-zero out the list
